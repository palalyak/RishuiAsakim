...
Scenario: הכנת_הודעה_באירוע_הפצה_01
	...
	* default tik rishuy with parameters for api mahut: 2, 3, 1
...
#	When create license in DB: 2, 8, 3,  "2023-02-06T10:00:00.100Z", "2033-01-13T10:00:00.100Z"
	When create draft license with parameters: 8, "2024-07-08T10:00:00.100Z", "2033-12-29T10:00:00.100Z", 7
...
#	Given run Ser028 create additional permit with parameters: 8, 0, 100, 1
#
#
